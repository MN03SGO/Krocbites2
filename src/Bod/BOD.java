...
import BDMySQL.ConexionProductos;
...
/**Conexion hacia otras ventanas del menu**/
   //1
import Empleados.KrokEmple;     //2        //5
...
public class BOD extends javax.swing.JFrame {
    ...
    ConexionProductos daoP=new ConexionProductos();
    ...
    private void guardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardar1ActionPerformed
                pr.setNombre(Tnombre.getText());
        pr.setPrecio(Double.parseDouble(Tprecio.getText()));
        if(daoP.insertar(pr)){
