...
public class ConexionEmpleados {
    ...
    public boolean insertar(empleado e){
     ...
     public DefaultTableModel listar(){
        ...
        String sql="SELECT e.id_empleado,e.nombre,e.apellido,e.tipoDoc,e.documento,"
                + "e.id_area, a.nom_area,e.id_cargo,c.nom_cargo,e.telefono,e.correo from empleados e"
                + " INNER JOIN areas a ON e.id_area=a.id_area INNER JOIN cargos c ON e.id_cargo=c.id_cargo;";
        try{
            con=cn.conectar();
            ps=con.prepareStatement(sql);
            rs=ps.executeQuery();
